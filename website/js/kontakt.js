// Ky skedar përkujdeset për formularin e kontaktit:
// - Validon fushat (emër, email, mesazh)
// - Ruajtjen e mesazheve në `localStorage` si inbox të thjeshtë
// - Shfaq mesazh suksesi dhe sjellje për UX
